...
import { ArrowRight, Receipt, BarChart3, Wallet, Users, Clock, User } from "lucide-react"
  ...
  const blogPosts = [
    {
      ...
      excerpt: "Belajar cara mengatur uang sejak dini akan membantu masa depan finansial yang lebih baik...",
    ...
    },
    {
      ...
      excerpt: "Jangan sampai masalah uang merusak persahabatan. Ini cara mudah bagi tagihan yang fair...",
      author: "Sarah Wijaya",
      date: "12 Jan 2024",
      readTime: "3 min",
      image: "/placeholder.svg?height=200&width=300",
    ...
    },
    {
      ...
      excerpt: "Tidak perlu lagi input manual satu per satu. Teknologi OCR membuat pencatatan jadi otomatis...",
      author: "Tech Team",
      date: "8 Jan 2024",
      readTime: "4 min",
      image: "/placeholder.svg?height=200&width=300",
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-100/50 relative overflow-hidden">
      ...
      <div className="ml-72 relative z-10">
        ...
        <section className="px-6 py-16">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-slate-800 font-display mb-4">Apa yang Bisa Kamu Lakukan?</h2>
              <p className="text-xl text-slate-600 font-body">Cek fitur yang kamu butuhin disini!</p>
            </div>
                ...
                >
                  <div className="flex items-center space-x-6">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-semibold text-slate-800 font-display mb-1">{item.title}</h3>
                      <p className="text-slate-600 font-body text-sm">{item.description}</p>
                    </div>
                  </div>
                  <Button
        ...
        <section className="px-6 py-16 bg-white/50 backdrop-blur-sm">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-slate-800 font-display mb-4">Tips & Insights</h2>
              <p className="text-xl text-slate-600 font-body">Baca artikel terbaru tentang keuangan dan teknologi</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {blogPosts.map((post) => (
                <Card key={post.id} className="group card-modern border-0 overflow-hidden cursor-pointer">
        ...
        <footer className="px-6 py-16 bg-slate-900 text-white">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
              ...
              <div className="md:col-span-1">
                <div className="flex items-center space-x-3 mb-6">
                  <div className="w-12 h-12 bg-gradient-to-br from-primary-500 via-secondary-500 to-primary-600 rounded-2xl flex items-center justify-center shadow-lg">
                    <span className="text-white font-bold text-lg font-display">LB</span>
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold font-display">LihatBill</h3>
                    <p className="text-slate-400 text-sm font-body">Kelola uang jadi mudah</p>
                  </div>
                </div>
              ...
              {/* Product */}
              <div>
                <h4 className="text-lg font-semibold font-display mb-4">Produk</h4>
                <ul className="space-y-3 font-body">
                  <li>
                    <a href="/splitbill" className="text-slate-300 hover:text-white transition-colors">
                      Split Bill
                    </a>
                  </li>
                  <li>
                  ...
                  <li>
                    <a href="/finance" className="text-slate-300 hover:text-white transition-colors">
                      Finance Tracker
                    </a>
                  </li>
                  <li>
              ...
              {/* Company */}
              <div>
                <h4 className="text-lg font-semibold font-display mb-4">Perusahaan</h4>
                <ul className="space-y-3 font-body">
                  <li>
                    <a href="#" className="text-slate-300 hover:text-white transition-colors">
                      Tentang Kami
              ...
              {/* Support */}
              <div>
                <h4 className="text-lg font-semibold font-display mb-4">Dukungan</h4>
                <ul className="space-y-3 font-body">
                  <li>
                    <a href="#" className="text-slate-300 hover:text-white transition-colors">
                      Help Center
            ...
            <div className="border-t border-slate-700 pt-8">
              <div className="flex flex-col md:flex-row justify-between items-center">
                <p className="text-slate-400 font-body text-sm">© 2024 LihatBill. All rights reserved.</p>
