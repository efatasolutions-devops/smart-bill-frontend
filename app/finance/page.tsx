...
import { TrendingUp, TrendingDown, DollarSign, Target, Plus, Crown } from "lucide-react"
      ...
      <div className="ml-72 p-6 relative z-10">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            <h1 className="text-4xl font-bold text-slate-800 font-display">Finance</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <Card className="card-modern border-0">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-slate-600 font-body">Total Income</CardTitle>
              <TrendingUp className="h-4 w-4 text-green-500" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-green-600 font-display">Rp {totalIncome.toLocaleString()}</div>
          ...
          <Card className="card-modern border-0">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-slate-600 font-body">Total Expenses</CardTitle>
              <TrendingDown className="h-4 w-4 text-red-500" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-red-600 font-display">Rp {totalExpenses.toLocaleString()}</div>
              <p className="text-xs text-slate-500 font-body">Bulan ini</p>
            </CardContent>
          </Card>
          ...
          <Card className="card-modern border-0">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-slate-600 font-body">Net Income</CardTitle>
              <DollarSign className="h-4 w-4 text-accent-500" />
            </CardHeader>
            <CardContent>
              <div className={`text-2xl font-bold font-display ${netIncome >= 0 ? "text-green-600" : "text-red-600"}`}>
          ...
          <Card className="card-modern border-0">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium text-slate-600 font-body">Budget Usage</CardTitle>
              <Target className="h-4 w-4 text-accent-500" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold text-slate-800 font-display">{budgetUsage}%</div>
              <p className="text-xs text-slate-500 font-body">Dari total budget</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="card-modern border-0">
            <CardHeader>
              <div className="flex justify-between items-center">
                <CardTitle className="text-slate-800 font-display">Transaksi Terbaru</CardTitle>
                ...
                {transactions.slice(0, 5).map((transaction) => (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="font-medium text-slate-800 font-body">{transaction.description}</p>
          ...
          <Card className="card-modern border-0">
            <CardHeader>
              <CardTitle className="text-slate-800 font-display">Budget Tracking</CardTitle>
              <CardDescription className="font-body">Pantau pengeluaran berdasarkan kategori</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {budgets.map((budget) => {
                  ...
                  return (
                    <div key={budget.category} className="space-y-2">
                      <div className="flex justify-between items-center">
                        <span className="font-medium text-slate-800 font-body">{budget.category}</span>
                      ...
                      <div className="flex justify-between text-xs">
                        <span className={`font-body ${isOverBudget ? "text-red-600" : "text-slate-500"}`}>
